...
import { defineCustomElement as defineCustomElement$19 } from '@ionic/core/components/ion-back-button.js';
import { defineCustomElement as defineCustomElement$1a } from '@ionic/core/components/ion-router-outlet.js';
...
import { defineCustomElement as defineCustomElement$1c } from '@ionic/core/components/ion-tabs.js';
import { defineCustomElement as defineCustomElement$1d } from '@ionic/core/components/ion-tab-bar.js';
import { defineCustomElement as defineCustomElement$1e } from '@ionic/core/components/ion-app.js';
import { defineCustomElement as defineCustomElement$1g } from 'ionicons/components/ion-icon.js';
import { defineCustomElement as defineCustomElement$1h } from '@ionic/core/components/ion-action-sheet.js';
import { defineCustomElement as defineCustomElement$1i } from '@ionic/core/components/ion-alert.js';
import { defineCustomElement as defineCustomElement$1j } from '@ionic/core/components/ion-loading.js';
import { defineCustomElement as defineCustomElement$1k } from '@ionic/core/components/ion-picker-legacy.js';
import { defineCustomElement as defineCustomElement$1l } from '@ionic/core/components/ion-toast.js';
import { defineCustomElement as defineCustomElement$1m } from '@ionic/core/components/ion-modal.js';
import { defineCustomElement as defineCustomElement$1n } from '@ionic/core/components/ion-popover.js';
...
const IonTab = /*@__PURE__*/ defineContainer('ion-tab', defineCustomElement$12, [
    'active',
    'delegate',
    'tab',
    'component'
]);
const IonText = /*@__PURE__*/ defineContainer('ion-text', defineCustomElement$13, [
    'color'
]);
const IonTextarea = /*@__PURE__*/ defineContainer('ion-textarea', defineCustomElement$14, [
    'color',
    'autocapitalize',
    'autofocus',
    'clearOnEdit',
...
const IonThumbnail = /*@__PURE__*/ defineContainer('ion-thumbnail', defineCustomElement$15);
const IonTitle = /*@__PURE__*/ defineContainer('ion-title', defineCustomElement$16, [
    'color',
    'size',
    'ionStyle'
]);
const IonToggle = /*@__PURE__*/ defineContainer('ion-toggle', defineCustomElement$17, [
    'color',
    'name',
    'checked',
    'disabled',
...
const IonToolbar = /*@__PURE__*/ defineContainer('ion-toolbar', defineCustomElement$18, [
    'color'
]);
...
const IonTabs = /*@__PURE__*/ defineComponent({
    ...
    render() {
        ...
        if (slottedContent && slottedContent.length > 0) {
            const slottedTabBar = slottedContent.find((child) => isTabBar(child));
            if (slottedTabBar) {
 ...
 */
const IonActionSheet = /*@__PURE__*/ defineOverlayContainer('ion-action-sheet', defineCustomElement$1h, ['animated', 'backdropDismiss', 'buttons', 'cssClass', 'enterAnimation', 'header', 'htmlAttributes', 'isOpen', 'keyboardClose', 'leaveAnimation', 'mode', 'subHeader', 'translucent', 'trigger']);
const IonAlert = /*@__PURE__*/ defineOverlayContainer('ion-alert', defineCustomElement$1i, ['animated', 'backdropDismiss', 'buttons', 'cssClass', 'enterAnimation', 'header', 'htmlAttributes', 'inputs', 'isOpen', 'keyboardClose', 'leaveAnimation', 'message', 'mode', 'subHeader', 'translucent', 'trigger']);
const IonLoading = /*@__PURE__*/ defineOverlayContainer('ion-loading', defineCustomElement$1j, ['animated', 'backdropDismiss', 'cssClass', 'duration', 'enterAnimation', 'htmlAttributes', 'isOpen', 'keyboardClose', 'leaveAnimation', 'message', 'mode', 'showBackdrop', 'spinner', 'translucent', 'trigger']);
const IonPickerLegacy = /*@__PURE__*/ defineOverlayContainer('ion-picker-legacy', defineCustomElement$1k, ['animated', 'backdropDismiss', 'buttons', 'columns', 'cssClass', 'duration', 'enterAnimation', 'htmlAttributes', 'isOpen', 'keyboardClose', 'leaveAnimation', 'mode', 'showBackdrop', 'trigger']);
const IonToast = /*@__PURE__*/ defineOverlayContainer('ion-toast', defineCustomElement$1l, ['animated', 'buttons', 'color', 'cssClass', 'duration', 'enterAnimation', 'header', 'htmlAttributes', 'icon', 'isOpen', 'keyboardClose', 'layout', 'leaveAnimation', 'message', 'mode', 'position', 'positionAnchor', 'swipeGesture', 'translucent', 'trigger']);
const IonModal = /*@__PURE__*/ defineOverlayContainer('ion-modal', defineCustomElement$1m, ['animated', 'backdropBreakpoint', 'backdropDismiss', 'breakpoints', 'canDismiss', 'enterAnimation', 'focusTrap', 'handle', 'handleBehavior', 'htmlAttributes', 'initialBreakpoint', 'isOpen', 'keepContentsMounted', 'keyboardClose', 'leaveAnimation', 'mode', 'presentingElement', 'showBackdrop', 'trigger'], true);
const IonPopover = /*@__PURE__*/ defineOverlayContainer('ion-popover', defineCustomElement$1n, ['alignment', 'animated', 'arrow', 'backdropDismiss', 'component', 'componentProps', 'dismissOnSelect', 'enterAnimation', 'event', 'focusTrap', 'htmlAttributes', 'isOpen', 'keepContentsMounted', 'keyboardClose', 'leaveAnimation', 'mode', 'reference', 'showBackdrop', 'side', 'size', 'translucent', 'trigger', 'triggerAction']);
...
const modalController = /*@__PURE__*/ createController(defineCustomElement$1m, modalController$1, true);
const popoverController = /*@__PURE__*/ createController(defineCustomElement$1n, popoverController$1, true);
const alertController = /*@__PURE__*/ createController(defineCustomElement$1i, alertController$1);
const actionSheetController = /*@__PURE__*/ createController(defineCustomElement$1h, actionSheetController$1);
const loadingController = /*@__PURE__*/ createController(defineCustomElement$1j, loadingController$1);
/**
 * @deprecated Use the inline ion-picker component instead.
 */
const pickerController = /*@__PURE__*/ createController(defineCustomElement$1k, pickerController$1);
const toastController = /*@__PURE__*/ createController(defineCustomElement$1l, toastController$1);
